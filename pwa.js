...
const cacheName = 'Fixit9AlexandraJoasXP-2020-10-17 11:20:27.671743'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit9AlexandraJoasXP'.length) === 'Fixit9AlexandraJoasXP') {
